        ...
        <div className="flex justify-between gap-5 items-end">
          <Input
            ...
            classNames={{
              ...
              inputWrapper: "border-1 rounded-xl border-gray-200 py-5",
            }}
          ...
          <div className="flex gap-3 theme">
            <Dropdown>
              <DropdownTrigger className="hidden sm:flex">
                <Button
                  className="rounded-xl py-5 !bg-gray-200 dark:!bg-[#374961]"
              ...
              <DropdownMenu
                ...
                className="theme rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.1)]"
              >
                {columns.map((column) => (
                  <DropdownItem
                    key={column.uid}
                    className="capitalize rounded-2xl hover:bg-gray-200 dark:hover:bg-[#374961] active:text-white transition-colors duration-200"
                  >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-10">
            ...
            <Select
              ...
              classNames={{
                trigger: "rounded-xl bg-white border border-gray-300 theme transition-colors",
                popoverContent: "theme rounded-xl shadow-xl",
                listbox: "p-1",
                base: "text-sm",
              }}
            >
              ...
              <SelectItem key="15" textValue="15">15</SelectItem>
            </Select>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="p-5 rounded-2xl theme shadow-2xl h-full">
      <Table
        ...
        checkboxesProps={{
          classNames: {
            wrapper: "dark:after:bg-[#6482aa] after:bg-[#b8c8ff] after:rounded-md before:rounded-lg before:opacity-40",
        ...
        classNames={{
          ...
          tr: "dark:hover:bg-[#26313f] hover:bg-gray-100  transition-all duration-300",
          thead: "rounded-t-lg ",
          tbody: "divide-y divide-gray-100 rounded-xl",
          wrapper: "max-h-[500px]",
        }}
      ...
      >
        ...
        <TableBody
          emptyContent={ <div className="text-gray-400 dark:text-gray-500 py-10 italic animate-pulse">
            No Menu found
          </div>}
          items={memoizedProducts ?? []}
          loadingContent={<div className="pt-50 "><Spinner className="text-blue-600" /></div>}

    ...
    <div className=" bg-[#3e3425] text-white rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          ...
          <div className="flex flex-col gap-2">
            <p>📍 Location</p>
            <p className=" text-sm">
              The café is located at {cafeData?.address_en}
            </p>
            <p>🕰 Opening Hours</p>
            <p className=" text-sm">
              Open daily from {formatTime(cafeData?.opening_time)} -{" "}
              {formatTime(cafeData?.closing_time)}
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <nav className=" flex flex-col gap-2">
            ...
            >
              <BsFacebook />
              <span className="text-sm">{cafeData?.facebook}</span>
            </a>
            ...
            >
              <RiTwitterXFill />
              <span className="text-sm">{cafeData?.x}</span>
            </a>
            ...
            >
              <BsInstagram />
              <span className="text-sm">{cafeData?.instagram}</span>
            </a>
          </nav>
        </div>
      </div>
      <div>
        <p className=" text-center py-4">
          © 2025 {cafeData?.name_en} | All rights reserved
        </p>
      </div>
    </div>
  );
